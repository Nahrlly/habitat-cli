...
export type ResourceMissionReport = ResourceMission & { iterations: Array<{ sequence: number; action: string; createdAt: string }>; collectedResources: EvaResource[]; errors: string[] };
